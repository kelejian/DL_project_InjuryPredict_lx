...
if __name__ == "__main__":
    ...
    Patience = 8  # 早停等待轮数
    base_loss = "mse"  # 或 "mae"
    weight_factor_classify = 2.50  # 加权损失函数的系数1
    weight_factor_sample = 2.0  # 加权损失函数的系数2
    # 定义模型相关的超参数
    Ksize_init = 10 # TCN 初始卷积核大小，必须是偶数
    Ksize_mid = 5  # TCN 中间卷积核大小，必须是奇数
    ...
    for epoch in range(Epochs):
        ...
        # 验证模型
        val_loss, val_accuracy, val_mae, val_rmse = valid(model, val_loader, criterion, device, y_transform=dataset.y_transform)

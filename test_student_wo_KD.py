""" Test the TCN-based pre-crash injury prediction model, i.e., the student model without KD. """
# -*- coding: utf-8 -*-
...
"""
    ...
    plt.title("Scatter Plot of Predictions vs Ground Truth On Test Set (Student Model without KD)") 
    plt.legend()
    plt.grid(True)
    plt.savefig('./results/student_model_wo_KD.png')
    plt.show()
